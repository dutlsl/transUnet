...
def main():
    ...
    # Naming for result distinction (Add tag reflecting optimized parameters)
    ...
    print(f"Starting TransUNet (s0={args.sigma0}, s1={args.sigma1}, ellipse={args.ellipse})")

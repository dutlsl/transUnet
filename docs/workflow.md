...
> [!NOTE]
> 누락된 **LPW (All)의 Ellipse Only, SF Only** 실험은 현재 백그라운드에서 각각 GPU 0과 1을 활용하여 실시간으로 구동 중입니다. 완료되는 대로 스코어를 업데이트하겠습니다.
...
모든 모듈 및 최적 파라미터 적용에 따른 최종 성과 테이블입니다.

| 단계 | 실험 조건 | Swirski mIoU | LPW (All) mIoU | 비고 |
|:---:|:---|:---:|:---:|:---|
| 1 | **순정 TransUNet (Baseline)** | 0.5831 | 0.5260 | 도메인 갭 발생 |
| 2 | Ellipse 후처리만 적용 | 0.6113 | **Running...** | |
| 3 | **Skip Filter 단독 적용 (σ=1.0)** | **0.6937** | **Running...** | **Main Contribution** |
...
![Baseline](/home/iulab1/.gemini/antigravity/brain/8e7b1692-f720-4b74-8526-abbcb83601e8/artifacts/baseline.png)

2. **Ellipse Only**: 파편화된 상태에서 피팅을 시도하여 찌그러진 타원이 생성됨.
![Ellipse Only](/home/iulab1/.gemini/antigravity/brain/8e7b1692-f720-4b74-8526-abbcb83601e8/artifacts/ellipse_only.png)

3. **SF Only**: Skip Filter로 속눈썹 노이즈를 지워 동공의 거시적 형태를 복원함.
![SF Only](/home/iulab1/.gemini/antigravity/brain/8e7b1692-f720-4b74-8526-abbcb83601e8/artifacts/sf_only.png)

4. **Final**: 깨끗해진 마스크에 타원 피팅을 적용하여 완벽한 동공을 완성함.
![Final](/home/iulab1/.gemini/antigravity/brain/8e7b1692-f720-4b74-8526-abbcb83601e8/artifacts/final.png)
